...
BACKEND_BUCKET="awsdpbucket"  # Replace with your existing S3 bucket name (the bucket must already exist)
BACKEND_REGION="us-east-1"
# The tfstate file key is built using the cluster name.
